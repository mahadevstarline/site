...
(function(e) {
    ...
    e.extend(o.prototype, {
            ...
            for (var f = this.s.dt, h = 0, b = !Array.isArray(b) ? [b] : b, i = 0, k = b.length; i < k; i++) {
                ...
                if (m)
                    if (Array.isArray(m))
                        ...
                        g && (d !== l && null !== d ? (a.splice(d, 0, g),
                        d++) : a.push(g),
                        g.conf.buttons && (g.collection = e("<" + this.c.dom.collection.tag + "/>"),
        ...
        _buildButton: function(a, b) {
            ...
            var k = function(a, b, c, d) {
              ...
              , g = e("<" + f + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(b) {
                b.preventDefault();
            ...
            d.tag ? (f = e("<" + d.tag + "/>").html(i(a.text)).addClass(d.className),
            "a" === d.tag.toLowerCase() && f.attr("href", "#"),
            g.append(f)) : g.html(i(a.text));
        ...
        _popover: function(a, b, c) {
            ...
            var d = e(b.table().container())
              , k = c.css("position");
            "dt-container" === f.align && (h = h.parent(),
            c.css("width", d.width()));
            if ("absolute" === k) {
                var m = h.position()
                  , k = e(b.node()).position();
                ...
                var k = d.offset().left
                  ...
                  , n = h.outerWidth()
                  , l = j + n;
                c.hasClass(f.rightAlignClassName) || c.hasClass(f.leftAlignClassName) || "dt-container" === f.align ? (n = 0,
                c.hasClass(f.rightAlignClassName) ? (n = l - g,
                k > m + n && (k -= m + n,
                d -= g + n,
                n = k > d ? n + d : n + k)) : (n = k - m,
                d < g + n && (k -= m + n,
                d -= g + n,
                n = k > d ? n + d : n + k))) : (d = h.offset().top,
                n = 0,
        ...
        var c = []
          ...
          , f = function(a) {
            if (Array.isArray(a))
                ...
                "string" === typeof a ? -1 !== a.indexOf(",") ? f(a.split(",")) : (a = e.inArray(a.trim(), d),
    ...
    o.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b, c) {
            ...
            if (Array.isArray(a) || a instanceof e) {
                ...
                "object" === typeof a && a.nodeName && (i = e.inArray(a, g),
                -1 !== i && c.push({
                    inst: b,
                    node: g[i]
                }))
        }, h = 0, i = a.length; h < i; h++)
            f(b, a[h]);
        return c
    }
    ;
    ...
    e.extend(p, {
        ...
        csv: function(a, b) {
            if (p.csvHtml5 && p.csvHtml5.available(a, b))
                return "csvHtml5"
        },
        excel: function(a, b) {
        ...
        pdf: function(a, b) {
            if (p.pdfHtml5 && p.pdfHtml5.available(a, b))
                return "pdfHtml5"
        },
        pageLength: function(a) {
            ...
            if (Array.isArray(a[0]))
                ...
                for (var d = 0; d < a.length; d++) {
                    var f = a[d];
                    e.isPlainObject(f) ? (b.push(f.value),
                    c.push(f.label)) : (b.push(f),
                    c.push(f))
                }
            return {
                extend: "collection",
    ...
    j.Api.register("button().add()", function(a, b) {
        var c = this.context;
        c.length && (c = o.instanceSelector(this._groupSelector, c[0]._buttons),
    ...
    j.Api.register("buttons.exportInfo()", function(a) {
        ...
        b === l || null === b ? b = null : (-1 !== b.indexOf("*") && (b = b.replace("*", e("head > title").text()).trim()),
...
(function(h) {
    ...
    function A(a, c) {
        ...
        h.each(c, function(c, b) {
            if (h.isPlainObject(b)) {
                ...
                x && (-1 === e.indexOf("<?xml") && (e = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + e),
    ...
    if ("undefined" === typeof l || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))
        ...
        var y = l.document.createElementNS("http://www.w3.org/1999/xhtml", "a")
          ...
          , F = function(a, c, d) {
            d || (a = E(a));
            var b = this, d = "application/octet-stream" === a.type, e, g = function() {
    ...
    p.ext.buttons.csvHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            !1 !== e ? (e || (e = j.characterSet || j.charset),
            e && (e = ";charset=" + e)) : e = "";
    ...
    p.ext.buttons.excelHtml5 = {
        ...
        action: function(a, c, d, b) {
            ...
            }, j = c.buttons.exportData(b.exportOptions), n, p, m = function(a) {
                n = g + 1;
                p = o(i, "row", {
                    attr: {
                        r: n
            ...
            t.title && (m([t.title], g),
            s(g, j.header.length - 1));
            t.messageTop && (m([t.messageTop], g),
            s(g, j.header.length - 1));
            b.header && (m(j.header, g),
            h("row:last c", i).attr("s", "2"));
            d = g;
            k = 0;
            for (var q = j.body.length; k < q; k++)
                m(j.body[k], g);
            k = g;
            b.footer && j.footer && (m(j.footer, g),
            h("row:last c", i).attr("s", "2"));
            t.messageBottom && (m([t.messageBottom], g),
            s(g, j.header.length - 1));
            m = o(i, "cols");
...
(function(g) {
    ...
    function x(a) {
        ...
        g.each(a, function(b, d) {
            if (g.isPlainObject(d))
                ...
                r && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c),
    ...
    var y = function(a, b) {
        ...
        header: !0,
        footer: !1
    }, v = "", v = "undefined" === typeof j.XMLSerializer ? new function() {
        this.serializeToString = function(a) {
            return a.xml
        }
    }
    : new XMLSerializer, r, q = {
        "_rels/.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
        "xl/_rels/workbook.xml.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/><Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>',
        "[Content_Types].xml": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="xml" ContentType="application/xml" /><Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml" /><Default Extension="jpeg" ContentType="image/jpeg" /><Override PartName="/xl/workbook.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml" /><Override PartName="/xl/worksheets/sheet1.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml" /><Override PartName="/xl/styles.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml" /></Types>',
    ...
    h.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            this.processing(!0);
            var a = c._flash, e = 0, f = g.parseXML(q["xl/worksheets/sheet1.xml"]), i = f.getElementsByTagName("sheetData")[0], d = {
                _rels: {
                ...
                for (var b = 0, d = a.length; b < d; b++) {
                    ...
                    }) : (l = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""),
                    h = o(f, "c", {
                        attr: {
                            t: "inlineStr",
                            r: g
            ...
            l.title && (h([l.title], e),
            n(e, k.header.length - 1));
            l.messageTop && (h([l.messageTop], e),
            n(e, k.header.length - 1));
            c.header && (h(k.header, e),
            g("row:last c", f).attr("s", "2"));
            for (var s = 0, r = k.body.length; s < r; s++)
                h(k.body[s], e);
            c.footer && k.footer && (h(k.footer, e),
            g("row:last c", f).attr("s", "2"));
            l.messageBottom && (h([l.messageBottom], e),
            n(e, k.header.length - 1));
            h = o(f, "cols");
    ...
    j.ext.buttons.print = {
        ...
        action: function(a, g, b, i) {
            var a = g.buttons.exportData(c.extend({
              ...
              , l = function(a, b) {
                for (var d = "<tr>", c = 0, e = a.length; c < e; c++)
                    d += "<" + b + " " + (h[c] ? 'class="' + h[c] + '"' : "") + ">" + (null === a[c] || a[c] === o ? "" : a[c]) + "</" + b + ">";
                return d + "</tr>"
            }
            ...
            if (e) {
                ...
                g.buttons.info(g.i18n("buttons.printErrorTitle", "Unable to open print view"), g.i18n("buttons.printErrorMsg", "Please allow popups in your browser for this site to be able to view the print view."), 5E3)
        },
        title: "*",
        messageTop: "*",
        messageBottom: "*",
        ...
        columnVisibility: {
            ...
            init: function(a, b, c) {
                ...
                a.on("column-visibility.dt" + c.namespace, function(b, e) {
                    ...
                    1 === a.columns(c.columns).count() && (d.text(c._columnText(a, c)),
...
$jscomp.polyfillIsolated = function(c, h, k, m) {
    ...
    null != h && (c ? $jscomp.defineProperty($jscomp.polyfills, n, {
        ...
        writable: !0,
        value: h
    }) : h !== k && ($jscomp.propertyToPolyfillSymbol[n] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(n) : $jscomp.POLYFILL_PREFIX + n,
    ...
    c.extend(t.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.blurable)
                c(k).on("mousedown" + d, function(g) {
                    ...
                    c(g.target).parents().filter(b.table().container()).length || c(g.target).parents("div.DTE").length || c(g.target).parents("div.editor-datetime").length || c(g.target).parents("div.dt-datetime").length || c(g.target).parents().filter(".DTFC_Cloned").length || a._blur()
                });
            if (this.c.editor) {
                var p = this.c.editor;
                p.on("open.keyTableMain", function(g, q, r) {
                    "inline" !== q && a.s.enable && (a.enable(!1),
            ...
            b.on("draw" + d, function(g) {
                ...
                if (!a.s.focusDraw && a.s.lastFocus) {
                    var q = a.s.lastFocus.relative
                      , r = b.page.info()
                      , v = q.row + r.start;
                    0 !== r.recordsDisplay && (v >= r.recordsDisplay && (v = r.recordsDisplay - 1),
        ...
        _blur: function(a) {
            if (this.s.enable && this.s.lastFocus) {
                ...
                a || (this._updateFixedColumns(b.index().column),
        ...
        _clipboard: function() {
            ...
            h.getSelection && (c(k).on("copy" + e, function(d) {
                ...
                var f = h.getSelection().toString()
                  , p = b.s.lastFocus;
                !f && p && (d.clipboardData.setData("text/plain", p.cell.render(b.c.clipboardOrthogonal)),
                d.preventDefault())
            }),
            c(k).on("paste" + e, function(d) {
                ...
                d = b.c.editor;
                var g;
                !p || l && "body" !== l.nodeName.toLowerCase() || (f.preventDefault(),
                ...
                d ? (f = b._inlineOptions(p.cell.index()),
                d.inline(f.cell, f.field, f.options).set(d.displayed()[0], g).submit()) : (p.cell.data(g),
                a.draw(!1)))
            }))
        },
        _columns: function() {
                    ...
                    var q = function() {
                        ...
                        p.one("open" + g, function() {
                            ...
                            p.one("close" + g, function() {
                                ...
                                d.s.returnSubmit && (d.s.returnSubmit = !1,
            ...
            if (this.s.enable) {
                ...
                if (-1 !== l.length && (a < l.start || a >= l.start + l.length))
                    ...
                    if (e === m || !0 === e)
                        ...
                        e !== p.table().header().parentNode && (e = c(e.parentNode),
        ...
        _shift: function(a, b, e) {
            ...
            if (g) {
                ...
                "right" === b ? f >= l.length - 1 ? (g++,
                q = l[0]) : q = l[f + 1] : "left" === b ? 0 === f ? (g--,
                q = l[l.length - 1]) : q = l[f - 1] : "up" === b ? g-- : "down" === b && g++,
                0 <= g && g < p && -1 !== c.inArray(q, l) ? (a && a.preventDefault(),
                this._focus(g, q, !0, a)) : e && this.c.blurable ? this._blur() : a && a.preventDefault())
            }
        },
        _tabInput: function() {
            var a = this
            ...
            this.s.tabInput = e),
            (e = this.s.dt.cell(":eq(0)", "0:visible", {
                page: "current",
                order: "current"
...
(function(e) {
    ...
    function A(a) {
        ...
        c.on("mousedown.dtSelect", d, function(b) {
            ...
            if (e(b.target).closest("div." + k)[0] == a.table().container() && (k = a.cell(e(b.target).closest("td, th")),
            k.any())) {
                var g = e.Event("user-select.dt");
                l(a, g, [c, k, b]);
                g.isDefaultPrevented() || (g = k.index(),
                "row" === c ? (c = g.row,
                u(b, a, d, "row", c)) : "column" === c ? (c = k.index().column,
                u(b, a, d, "column", c)) : "cell" === c && (c = k.index(),
                u(b, a, d, "cell", c)),
    ...
    function u(a, c, b, d, f) {
        ...
        if (!j || g)
            "os" === e ? a.ctrlKey || a.metaKey ? c[d](f).select(!j) : a.shiftKey ? "cell" === d ? x(c, f, b._select_lastCell || null) : B(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : (a = c[d + "s"]({
                selected: !0
            }),
            j && 1 === a.flatten().length ? c[d](f).deselect() : (a.deselect(),
            c[d](f).select())) : "multi+shift" == e ? a.shiftKey ? "cell" === d ? x(c, f, b._select_lastCell || null) : B(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : c[d](f).select(!j) : c[d](f).select(!j)
    }
    function z(a) {
    ...
    g.select.init = function(a) {
        ...
        if (!0 === b)
            ...
            f = b,
            s = !0;
        else if (e.isPlainObject(b) && (b.blurable !== h && (n = b.blurable),
    ...
    e.each([{
        ...
        g.ext.selector[c.type].push(function(b, a, f) {
            ...
            for (var j = 0, k = f.length; j < k; j++)
                e = b[c.prop][f[j]],
                (!0 === a && !0 === e._select_selected || !1 === a && !e._select_selected) && g.push(f[j]);
            return g
        })
    });
